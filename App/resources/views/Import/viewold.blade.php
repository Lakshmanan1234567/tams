				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header ">
							...
							<a href="{{url('/')}}/uploads/format-excel/FormateExcel.xlsx" class="btn btn-sm btn-outline-info text-right" id="btnFormatxl ">Formate Excel</a>
							<button  class="btn btn-sm btn-outline-warning text-right" id="btnMapping">Mapping</button>
