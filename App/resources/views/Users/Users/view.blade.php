						...
						<div class="card-header text-center">
							<div class="form-row d-flex justify-content-center align-items-center">
								...
								<h5 class="d-none">User Count - ({{$UserCount}})</h5>
									@if($crud['add']==1)
										<a href="{{ url('/') }}/users-and-permissions/users/create" class="btn  btn-outline-primary btn-air-success btn-sm" type="button" >Create</a> <!-- full-right -->
									@endif
								    @if($crud['view']==1)
										<a href="{{ url('/') }}/users-and-permissions/users/Import" class=" btn  btn-outline-success btn-air-success btn-sm" type="button" >Import</a> <!-- full-right -->
									@endif
									@if($crud['restore']==1)
										<a href="{{ url('/') }}/users-and-permissions/users/trash-view" class="btn d-none  btn-outline-light btn-sm m-r-10" type="button" > Trash view </a>
									@endif									
								</div>
							</div>
						</div>
...
<script>
    $(document).ready(function(){
		...
		$(document).on('click','.btnDelete',function(){
			...
			swal({
                title: "Are you sure?",
                text: "You want Delete this Thadco Member!",
                type: "warning",
