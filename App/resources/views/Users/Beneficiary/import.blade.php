				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header ">
							...
							<a href="{{url('/')}}/uploads/format-excel/FormateExcelBen.xlsx" class="btn btn-sm btn-outline-info text-right" id="btnFormatxl ">Formate Excel</a>
	...
	$('#btnSubmit').click(function(){
		...
		console.log($('#FileUpload')[0].files[0]);
			...
			swal({
				...
				let postUrl="{{url('/')}}/users-and-permissions/import/BENsave";
